...
export default {
  name: 'x',
  data: {"keywords":["remove","close","delete"],"path":"<path fill-rule=\"evenodd\" d=\"M7.48 8l3.75 3.75-1.48 1.48L6 9.48l-3.75 3.75-1.48-1.48L4.52 8 .77 4.25l1.48-1.48L6 6.52l3.75-3.75 1.48 1.48z\"></path>","height":"16","width":"12"},
  options: {
    'version': '1.1',
    'width': 12,
    'height': 16,
