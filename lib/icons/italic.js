...
var italic = {
  name: 'italic',
  data: { "keywords": ["font", "italic", "style"], "path": "<path fill-rule=\"evenodd\" d=\"M2.81 5h1.98L3 14H1l1.81-9zm.36-2.7c0-.7.58-1.3 1.33-1.3.56 0 1.13.38 1.13 1.03 0 .75-.59 1.3-1.33 1.3-.58 0-1.13-.38-1.13-1.03z\"></path>", "height": "16", "width": "6" },
  options: {
    'version': '1.1',
    'width': 6,
    'height': 16,
