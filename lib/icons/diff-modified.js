...
var diffModified = {
  name: 'diff-modified',
  data: { "keywords": ["dot", "changed", "updated"], "path": "<path fill-rule=\"evenodd\" d=\"M13 1H1c-.55 0-1 .45-1 1v12c0 .55.45 1 1 1h12c.55 0 1-.45 1-1V2c0-.55-.45-1-1-1zm0 13H1V2h12v12zM4 8c0-1.66 1.34-3 3-3s3 1.34 3 3-1.34 3-3 3-3-1.34-3-3z\"></path>", "height": "16", "width": "14" },
  options: {
    'version': '1.1',
    'width': 14,
    'height': 16,
